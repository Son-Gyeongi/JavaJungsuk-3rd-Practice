...
public class CalendarEx7 {
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Usage : java CalendarEx7 2025 11");
            return;
        }
        ...
        // 예를 들어, 2025년 11월 1일은 sDay.set(2025,10,1);과 같이 해줘야 한다.
        sDay.set(2025, month - 1, 1); // 입력월의 1일로 설정한다.
        // 입력월의 말일로 설정한다.
        eDay.set(2025, month - 1, sDay.getActualMaximum(Calendar.DATE));
        // 1일이 속한 주의 일요일로 날짜설정
